...
class ModelCheckoutOrder extends Model {
	public function addOrder($data) {
        ...
        //   $this->db->query("INSERT INTO " . DB_PREFIX . "order_custom SET order_id = '" . (int)$order_id . "', order_product_id = '" . (int)$order_product_id . "', name = '" . $this->db->escape($custom['label']) . "', `value` = '" . $this->db->escape($custom['value']) . "'");
        // }
        ////////////////////
	...
	public function editOrder($order_id, $data) {
        ...
        $this->db->query("DELETE FROM " . DB_PREFIX . "order_custom WHERE order_id = '" . (int)$order_id . "'");
	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'custom_data'             => $order_query->row['custom_data'],
